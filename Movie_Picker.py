...
add_button = tk.Button(frame, text="Add", command=add_movie, bg="red", fg="white")
add_button.grid(row=0, column=1)

listbox = tk.Listbox(frame, bg="green", fg="white")
listbox.grid(row=1, column=0, columnspan=2)

spin = tk.Spinbox(frame, from_=1, to=100, bg="green", fg="white")
spin.grid(row=2, column=0)

draw_button = tk.Button(frame, text="Draw", command=draw, bg="red", fg="white")
draw_button.grid(row=2, column=1)

results_label = tk.Label(frame, text="", bg="red", fg="white")
